<?php
    ...
    $nom = $_POST['inscr-id']; // Nom saisi lors de l'inscription, Mayuri par exemple
    $mdp = hash('SHA256', $_POST['inscr-pwd']); // Mot de passe saisi lors de l'inscription qui sera hashé, par exemple Mdp_Tuturu-001 = eaa5f20c4576722347fc740f6bed71adefb9b01ca425cbca274e610bfec24b39
